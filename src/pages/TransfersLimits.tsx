...
export const TransfersLimits: React.FC = () => {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold text-gray-900">Gerenciar Limites</h1>
        <p className="text-gray-600 mt-2">Gerencie e acompanhe gerenciar limites</p>
      </div>
          ...
          <div className="flex items-start gap-3 p-4 bg-blue-50 rounded-lg">
            ...
            <div>
              ...
              <p className="text-sm text-blue-700 mt-1">
                ...
                Todas as operações relacionadas a gerenciar limites estarão disponíveis aqui.
              </p>
            </div>
          </div>
